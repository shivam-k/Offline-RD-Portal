...
<!DOCTYPE html>
<head>
		  <title>Hoverpod--team grouping</title>
		  <meta charset="utf-8">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown ">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="#">Hoverpod</a></li>
...
<div class="well" style="box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16),0 2px 10px 0 rgba(0,0,0,0.12)!important;"> 
   <h2 class="text-center"><kbd style="background-color: #FF4A56;">Hoverpod--Team Grouping on RD</kbd></h2>
...
for($y=1; $y <= $x; $y++) {
    $k = 0;
    for($z=1; $z < $y; $z++) {
      if($hoverpod[$y] != $hoverpod[$z]){
          $k++;
      }
    }
      if($k == ($y-1)){
        $getpname = "SELECT * FROM hpevent WHERE teamid = '$hoverpod[$y]'";
